...
const Notification = () => {
    ...
    return (
        <>
            ...
            <div className="" onClick={toggleNotification}>

                <svg className='notification-svg' width="30" height="34" viewBox="0 0 30 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="position-absolute notifications bottom-0 start-100 translate-middle badge border border-light rounded-circle bg-danger">
