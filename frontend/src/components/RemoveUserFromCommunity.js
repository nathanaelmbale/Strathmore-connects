    ...
    <div>
      ...
      <form onSubmit={handleRemoveUser}>
        <div className="form-group">
          ...
          <div className='my-3'>
            <button type='submit' className='btn btn-primary container'>Remove user</button>
            {userError && <div className='danger alert-danger'>{userError}</div>}
            {userSuccess && <div className='success alert-success'>{userSuccess}</div>}
          </div>
        </div>
